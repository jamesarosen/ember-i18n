...
test_stables: jshint development_dependencies vendor_install
	...
	JQUERY_VERSION=1.11.0 EMBER_VERSION=release HANDLEBARS_VERSION=2.0.0 ./script/run.js
	JQUERY_VERSION=2.0.3 EMBER_VERSION=release HANDLEBARS_VERSION=2.0.0 ./script/run.js
