(function (window) {
  "use strict";
  var Ember = window.Ember, CLDR = window.CLDR, jQuery = window.jQuery,
      Handlebars = window.Handlebars,
      I18n, assert, findTemplate, get, isBinding, isTranslatedAttribute, lookupKey, pluralForm;

  isTranslatedAttribute = /(\S+)Translation$/;
  ...
  if (pluralForm == null) {
    Ember.Logger.warn("CLDR.pluralForm not found. Ember.I18n will not support count-based inflection.");
  }
  ...
  Handlebars.registerHelper('t', function (key, options) {
    ...
    Ember.keys(attrs).forEach(function (property) {
      var bindPath, currentValue, invoker, isBindingMatch, normalized,
          normalizedPath, observer, propertyName, root, _ref;
